...
describe("Places/controller", () => {
  ...
  //DONE Ajouter ici le test qui vérifie le nombre de place remonté par l'api
  it("GET /api/places number of places should be 3", () => {
    const app = new App(new Place(new PlaceData())).app;
    return request(app)
      .get("/api/places")
      .expect("Content-Type", /json/)
  ...
  it('POST /api/places should respond a http 201 OK with no image', () => {
    ...
    it('DELETE /api/places/5 should respond a http 404 not found', () => {
        const app = new App(new Place(new PlaceData())).app;
        return request(app)
            .delete('/api/places/5')
            .expect(404);
    ...
    it('DELETE /api/places/1 should respond a http 204', () => {
        const app = new App(new Place(new PlaceData())).app;
        return request(app)
            .delete('/api/places/1')
            .expect(204);
